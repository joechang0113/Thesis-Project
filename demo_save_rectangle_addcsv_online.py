...
def main(yolo):
   ...
   # deep_sort 
    ...
    # Define the codec and create VideoWriter object
        ...
        out = cv2.VideoWriter('output_test_cross0521_1.avi', fourcc, 15, (w, h))
       ...
       # print("box_num",len(boxs))
        ...
        for track in tracker.tracks:
            ...
            if number % 10 == 0:
                ...
                # with open('./output_XYBegin_0501.csv', 'w') as csvfile:
                #     writer = csv.writer(csvfile)
        ...
        if cv2.waitKey(1) & 0xFF == ord('q'):
            # Save file to excel with csv in output
            with open('./output_test_cross0521_1.csv', 'w') as csvfile:
                for i in trackId_list:
                    writer = csv.writer(csvfile)
