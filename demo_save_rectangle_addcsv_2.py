...
def main(yolo):
   ...
   # deep_sort 
    ...
    # Define the codec and create VideoWriter object
        ...
        out = cv2.VideoWriter('output_test_cross0501_G.avi', fourcc, 15, (w, h))
       ...
       # print("box_num",len(boxs))
        ...
        for track in tracker.tracks:
            ...
            if tracker_Id in trackId_list and keyboard.is_pressed('g'):# if key 'g' is pressed 
                ...
                with open('./output_process_0501_G.csv', 'a') as csvfile:
                ...
                # with open('./output_XYBegin_0427.csv', 'w') as csvfile:
                #     writer = csv.writer(csvfile)
        ...
        if cv2.waitKey(1) & 0xFF == ord('q'):
            # Save file to excel with csv in output
            with open('./output_test_cross0501_G.csv', 'w') as csvfile:
                for i in trackId_list:
                    writer = csv.writer(csvfile)
