...
def main(yolo):
   ...
   # deep_sort 
    ...
    # Define the codec and create VideoWriter object
        ...
        out = cv2.VideoWriter('output_test_cross0614_8.avi', fourcc, 15, (w, h))
       ...
       # print("box_num",len(boxs))
        ...
        for track in tracker.tracks:
            ...
            if number % 10 == 0:
                ...
                globals()['trackerId'+str(tracker_Id)+'_time'].append(localtime)
                ...
                print('trackerId'+str(tracker_Id)+'_time',globals()['trackerId'+str(tracker_Id)+'_time'])
        ...
        if cv2.waitKey(1) & 0xFF == ord('q'):
            # Save file to excel with csv in output
            with open('./output_test_cross0614_8.csv', 'w') as csvfile:
                for i in trackId_list:
                    ...
                    writer.writerow(['timeId'+str(i), globals()['timeId'+str(i)]])
